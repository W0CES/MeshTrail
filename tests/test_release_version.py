...
def test_mismatched_manifest_version_is_rejected(tmp_path: Path) -> None:
    ...
    with pytest.raises(ValueError, match="openhop-plugin.json=0.5.0"):
        check_release_version("v0.4.0", tmp_path)
